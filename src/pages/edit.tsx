...
const Edit = () => {
    ...
    const saveData = () => {
        if (process.env.NODE_ENV === "development") {
            ...
            alert("You can't save data in production mode");
        }
    }

    const editProjects = (projectIndex: number, editProject: { title: string; id: string; description: string; imageSrc: string; url: string; }) => {
    ...
    const editServices = (serviceIndex: number, editService: { title: string; id: string; description: string; }) => {
    ...
    const editSocials = (socialIndex: number, editSocial: { title: string; id: string; link: string; }) => {
    ...
    const handleEditExperiences = (index: number, editExperience: { dates: string; id: string; type: string; position: string; bullets: string; }) => {
